    ...
    routes(): void {
            ...
            const options = {
                swaggerDefinition: {
                    ...
                    info: {
                        ...
                        version: "1.0.0",
                        description:
                            "This is a documentation about the endpoints called by the pusher. \n You can find out more about Cambria on [github](https://github.com/thecodingmachine/workadventure).",
                        contact: {
                            email: "hello@cambria.gg",
                        },
                    },
        ...
        this.app.get("/openapi/external-admin", (req, res) => {
            ...
            const options = {
                ...
                //openapi: "3.0.0",
                info: {
                    title: "Cambria External Admin",
                    version: "1.0.0",
                    description:
                        "This is a documentation about the external endpoints called by the pusher (aka the Admin API). \n Those endpoints should be implemented by the Admin API. The pusher will access those endpoints (just like webhooks). You can find out more about Cambria and the Admin API on [GitHub](https://github.com/thecodingmachine/workadventure/blob/develop/docs/dev/adminAPI.md).",
                    contact: {
                        email: "hello@cambria.gg",
                    },
                },
                            ...
                            parameters: [
                                {
                                    name: "playUri",
                                    in: "query",
                                    description: "The full URL of Cambria",
                                    required: true,
                                    type: "string",
        ...
        this.app.get("/swagger-ui/*", (request, response) => {
            ...
            const file = undefined; // LiveAssets.get(path);  TODO: fix this - weird typescript error when importing live-directory even with live-directory.d.ts
