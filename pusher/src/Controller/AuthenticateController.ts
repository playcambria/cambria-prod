...
export class AuthenticateController extends BaseHttpController {
            ...
            try {
                ...
                if (token != undefined) {
                    try {
                        ...
                        //This is very important to create User Local in LocalStorage in Cambria
     ...
     *                   example: https://play.cambria.gg/@/foo/bar/baz
     ...
     * /anonymLogin:
     *   post:
     *     description: Generates an "anonymous" JWT token allowing to connect to Cambria anonymously.
     *     responses:
     *       200:
     *         description: The details of the logged user
     *         content:
