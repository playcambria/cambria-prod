...
export const isFetchMemberDataByUuidResponse = z.object({
    ...
    walletAddress: extendApi(z.nullable(z.string()), {
        description: "User's wallet address",
        example: "0x9e352CD0bd893d1b0cB783b057fd68De27AD3c92",
    }),
    textures: extendApi(z.array(isWokaDetail), {
        description: "This data represents the textures (avatar) that will be available to users.",
    ...
    anonymous: extendApi(z.optional(z.boolean()), {
        description: "Defines whether it is possible to login as anonymous on a Cambria room.",
        example: false,
    }),
...
class AdminApi implements AdminInterface {
    async fetchMapDetails(
         ...
         *        required: true
         *        type: "string"
         *        example: "http://play.cambria.localhost/@/teamSlug/worldSLug/roomSlug"
         *      - name: "userId"
         *        in: "query"
