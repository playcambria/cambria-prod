...
export type ChatCallback = (chatEventMessage: ChatEventMessage, listener: ZoneSocket) => void;
export type PfpUpdateCallback = (pfpUpdateMessage: PfpUpdateMessage, listener: ZoneSocket) => void;
...
export class Zone {
    ...
    constructor(
        ...
        private onPfpUpdate: PfpUpdateCallback,
    ...
    public emitChatEvent(chatEventMessage: ChatEventMessage) {
        for (const listener of this.listeners) {
            this.onChat(chatEventMessage, listener);
        }
    }

    public emitPfpUpdateEvent(pfpUpdateMessage: PfpUpdateMessage) {
        for (const listener of this.listeners) {
