                ...
                try {
                    if (room === null || user === null) {
                        ...
                        if (message.hasJoinroommessage()) {
                            ...
                            socketManager.handleChatEventMessage(
                                room,
                                user,
                                message.getChatpromptmessage() as ChatPromptMessage
                            );
                        } else if (message.hasTrademessage()) {
                            socketManager.handleTradeMessage(room, user, message.getTrademessage() as TradeMessage);
                        } else if (message.hasPfpupdatemessage()) {
                            console.log("Room Manager Pfp Update");
                            socketManager.handlePfpUpdateMessage(
                                room,
                                user,
                                message.getPfpupdatemessage() as PfpUpdateMessage
                            );
