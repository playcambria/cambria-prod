...
/**
 * List event types sent from an iFrame to Cambria
 */
...
/**
 * List event types sent from an iFrame to Cambria that expect a unique answer from Cambria along the type for the answer from Cambria to the iFrame.
