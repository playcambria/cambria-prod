...
const menu: NonNullable<Translation["menu"]> = {
    ...
    settings: {
        ...
        privacySettings: {
            ...
            explanation: "Falls der Cambria Tab nicht aktiv ist, wird in den „Abwesenheitsmodus“ umgeschaltet.",
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "Mit Cambria kannst du eine Onlinewelt schaffen in der du dich spontan mit Anderen treffen und unterhalten kannst. Erstelle als erstes deine eigene Karte. Es steht dir eine großen Auswahl an vorgefertigten Karten von unserem Team zur Auswahl.",
        },
        createMap: {
