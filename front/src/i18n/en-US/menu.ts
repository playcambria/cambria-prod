...
const menu: BaseTranslation = {
    ...
    settings: {
        ...
        privacySettings: {
            title: "Away mode",
            explanation:
                'While the Cambria tab in your browser is not visible. Cambria switches to "away mode"',
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "Cambria allows you to create an online space to communicate spontaneously with others. And it all starts with creating your own space. Choose from a large selection of prefabricated maps by our team.",
        },
        createMap: {
