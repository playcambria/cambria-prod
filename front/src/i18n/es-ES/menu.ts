...
const menu: NonNullable<Translation["menu"]> = {
    ...
    settings: {
        ...
        privacySettings: {
            ...
            explanation:
                'Cuando la pestaña de Cambria en su navegador no es visible, Cambria cambia a "modo no presente"',
    ...
    contact: {
        gettingStarted: {
            title: "Empezar",
            description:
                "Cambria le permite crear un espacio en línea para comunicarse espontáneamente con otros. Y todo empieza creando su propio espacio. Escoja de una gran selección de mapas prefabricados por nuestro equipo.",
        },
        createMap: {
            title: "Crear su mapa",
