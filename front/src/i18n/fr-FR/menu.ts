...
const menu: NonNullable<Translation["menu"]> = {
    ...
    settings: {
        ...
        privacySettings: {
            title: "Mode absent",
            explanation:
                "Quand l'onglet Cambria de votre navigateur n'est pas visible, Cambria passe en \"mode absent\"",
    ...
    contact: {
        gettingStarted: {
            ...
            description:
                "Cambria vous permet de créer un espace en ligne pour communiquer spontanément avec d'autres personnes. Et tout commence par la création de votre propre espace. Choisissez parmi une large sélection de cartes préfabriquées par notre équipe.",
        },
        createMap: {
