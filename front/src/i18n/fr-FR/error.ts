...
const error: NonNullable<Translation["error"]> = {
    accessLink: {
        ...
        details:
            "Si vous souhaitez obtenir de plus amples informations, vous pouvez contacter l'administrateur ou nous contacter à l'adresse suivante: hello@cambria.gg",
    },
    connectionRejected: {
    ...
    connectionRetry: {
        unableConnect: "Impossible de se connecter à Cambria. Etes vous connecté à Internet?",
    },
    error: "Erreur",
};
