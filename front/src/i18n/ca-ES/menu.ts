...
const menu: NonNullable<Translation["menu"]> = {
    ...
    settings: {
        ...
        privacySettings: {
            ...
            explanation:
                'Quan la pestanya de Cambria al seu navegador no és visible, Cambria cambia al "mode no present"',
    ...
    contact: {
        gettingStarted: {
            title: "Començar",
            description:
                "Cambria us permet crear un espai en línia per comunicar-vos espontàneament amb altres. I tot comença creant el vostre propi espai. Escolliu entre una gran selecció de mapes prefabricats pel nostre equip.",
        },
        createMap: {
